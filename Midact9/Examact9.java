...
public class Examact9 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Search/Delete Exam");
            System.out.println("6. Sort Exams"); // NEW
            ...
            switch (choice) {
                ...
                case 6: 
                    if (count == 0) {
                        ...
                        int sortChoice = InputInteger("Enter choice: ");
                        ...
                        for (int i = 0; i < count - 1; i++) {
                            for (int j = 0; j < count - i - 1; j++) {
                                ...
                                if (condition) {
                                    ...
                                    String tempSubject = subject[j];
                                    subject[j] = subject[j + 1];
                                    subject[j + 1] = tempSubject;

                                    String tempDate = date[j];
                                    date[j] = date[j + 1];
                                    date[j + 1] = tempDate;

                                    double tempDuration = duration[j];
                                    duration[j] = duration[j + 1];
                                    duration[j + 1] = tempDuration;

                                    String tempRoom = room[j];
                                    room[j] = room[j + 1];
                                    room[j + 1] = tempRoom;
                                }
                            }
                        ...
                        System.out.println("Exams sorted successfully!");
