...
public class Exam {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    displayAll(examID, subject, date, duration, room, count);
                    break;
    ...
    public static void displayAll(int[] examID, String[] subject, String[] date, double[] duration, String[] room, int count) {
